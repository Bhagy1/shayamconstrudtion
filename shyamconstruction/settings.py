"""
Django settings for shyamconstruction project.
...
SECRET_KEY = 'django-insecure-$7xxmnhbtwtcso#4pw5tflc6mh59hmb83%)6-fh-tek$-=!cb7'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # where collected files go
MEDIA_URL = '/media/'
